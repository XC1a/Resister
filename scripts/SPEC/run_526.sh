...
export exeP="../../build/build_base_mytest-m64.0000/blender_r"
...
cd ${useP}cpu2017/benchspec/CPU/526.blender_r/run/run_base_refrate_mytest-m64.0000

${useP}${repo}/build/X86/gem5.opt \
-d ${useP}"gem5-hetero-garnet/scripts/SPEC/m5out/" \
${useP}${repo}/configs/my/se.py \
--cmd=${exeP} \
--option="--render-output sh3_no_char_ --threads 1 -b -F RAWTGA -s 849 -e 849 -a" \
--ruby \
--router-latency=3 \
--link-latency=27 \
--num-cpus=${core_num} \
