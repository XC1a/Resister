...
#note use ldecod_r -i BuckBunny.264 -o BuckBunny.yuv to generate the input file
export exeP="../../build/build_base_mytest-m64.0000/x264_r"
...
cd ${useP}cpu2017/benchspec/CPU/525.x264_r/run/run_base_refrate_mytest-m64.0000

${useP}${repo}/build/X86/gem5.opt \
-d ${useP}"gem5-hetero-garnet/scripts/SPEC/m5out/" \
${useP}${repo}/configs/my/se.py \
--cmd=${exeP} \
--option="--seek 500 --dumpyuv 200 --frames 1250 -o BuckBunny_New.264 BuckBunny.yuv 1280x720" \
--ruby \
--router-latency=3 \
--link-latency=27 \
--num-cpus=${core_num} \
