...
export exeP="../../build/build_base_mytest-m64.0000/namd_r"
...
cd ${useP}cpu2017/benchspec/CPU/508.namd_r/run/run_base_refrate_mytest-m64.0000

${useP}${repo}/build/X86/gem5.opt \
-d ${useP}"gem5-hetero-garnet/scripts/SPEC/m5out/" \
${useP}${repo}/configs/my/se.py \
--cmd=${exeP} \
--option="--input apoa1.input --output apoa1.ref.output --iterations 65" \
--ruby \
--router-latency=3 \
--link-latency=27 \
--num-cpus=${core_num} \
