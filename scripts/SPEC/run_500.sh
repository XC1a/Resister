...
export exeP="../../build/build_base_mytest-m64.0000/perlbench_r"
...
cd ${useP}cpu2017/benchspec/CPU/500.perlbench_r/run/run_base_refrate_mytest-m64.0000

${useP}${repo}/build/X86/gem5.opt \
-d ${useP}"gem5-hetero-garnet/scripts/SPEC/m5out/" \
${useP}${repo}/configs/my/se.py \
--cmd=${exeP} \
--option="-I./lib diffmail.pl 4 800 10 17 19 300" \
--ruby \
--router-latency=3 \
--link-latency=27 \
--num-cpus=${core_num} \
