...
export exeP="../../build/build_base_mytest-m64.0000/nab_r"
...
cd ${useP}cpu2017/benchspec/CPU/544.nab_r/run/run_base_refrate_mytest-m64.0000

${useP}${repo}/build/X86/gem5.opt \
-d ${useP}"gem5-hetero-garnet/scripts/SPEC/m5out/" \
${useP}${repo}/configs/my/se.py \
--cmd=${exeP} \
--option="1am0 1122214447 122" \
--ruby \
--router-latency=3 \
--link-latency=27 \
--num-cpus=${core_num} \
