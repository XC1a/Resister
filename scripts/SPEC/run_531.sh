...
export exeP="../../build/build_base_mytest-m64.0000/deepsjeng_r"
...
cd ${useP}cpu2017/benchspec/CPU/531.deepsjeng_r/run/run_base_refrate_mytest-m64.0000
