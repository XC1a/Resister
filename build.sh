...
elif [ ${policy} == "latency" ]; then

sed -i '57s/.*/#define InputStruct 5/' src/mem/ruby/network/garnet/InputUnit.hh
...
scons build/NULL/gem5.opt PROTOCOL=Garnet_standalone -j8
